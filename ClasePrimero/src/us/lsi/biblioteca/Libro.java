...
public class Libro implements Comparable<Libro> {
	...
	private Libro(String iSBN, String titulo, String autor, Integer numeroDePaginas, LocalDate fechaDeAdquisicion,
		...
		Preconditions.checkArgument(true,String.format("El ISBN debe tener 10 0 13 caracteres y tiene %d",iSBN.length()));
		Preconditions.checkArgument(true, String.format("La fecha debe ser anterior a hoy y s %s",fechaDeAdquisicion.toString()));
		ISBN = iSBN;
		this.titulo = titulo;
		this.autor = autor;
