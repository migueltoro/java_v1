...
public class TestBiblioteca {
	...
	public static void main(String[] args) {
		...
		Libro libro2 = Libro.of("9780385537716","El pa�s de los lagos", "Manuel Zimerman",700, 
				LocalDate.of(2000, 1, 14), 30.,600,TipoPrestamo.MENSUAL);
		System.out.println(libro2);
		Libro libro3 = Libro.of("9711385537716","La nueva esperanza", "Adela R�os",200, 
...
//		biblioteca.a�adeLibro(libro4);
//		biblioteca.a�adeLibro(libro5);
