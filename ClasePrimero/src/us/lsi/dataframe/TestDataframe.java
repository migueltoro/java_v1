...
public class TestDataframe {
	...
	public static void main(String[] args) {	
	    DataFrame d = DataFrame.parse("dataframe/personas.csv",List.of("Nombre","Apellido","Edad","Altura","Fecha"));
...
//	    DataFrame d3 = DataFrame.parse("ficheros/personas.csv",List.of("Nombre","Apellido","Edad","Altura","Fecha"));
		DataFrame d3 = DataFrame.parse("dataframe/personas.csv");
