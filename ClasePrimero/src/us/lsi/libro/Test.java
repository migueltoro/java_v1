...
public class Test {
	...
	public static void main(String[] args) {
		...
		Integer n = Libro.of().numeroDeLineas("ficheros/quijote.txt");
...
//		System.out.println(CollectionsTools.collectionToString(s));
		n = Libro.of().numeroDePalabrasDistintasNoHuecas("ficheros/quijote.txt");
		System.out.println(n);
		Double m1 = Libro.of().longitudMediaDeLineas("ficheros/quijote.txt");
		System.out.println(m1);
//		System.out.println(m1+","+m3);
		n = Libro.of().numeroDeLineaConPalabra("ficheros/quijote.txt","calzas");
		System.out.println(Libro.of().lineaNumero("ficheros/quijote.txt", n));
...
//		System.out.println(Map2.mapToString(Libro.lineasDePalabra("ficheros/quijote.txt")));
	}
